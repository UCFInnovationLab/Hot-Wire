...
// Xmit MSB
    ...
    USCI_B_SPI_transmitData(USCI_B0_BASE, (uint8_t)((temp & 0xFF00) >> 8 ));
    // wait until done
    while (!USCI_B_SPI_getInterruptStatus(USCI_B0_BASE,
                                            USCI_B_SPI_RECEIVE_INTERRUPT)) ;
    dummy0 =  USCI_B_SPI_receiveData(USCI_B0_BASE);
...
// Xmit LSB
    ...
    USCI_B_SPI_transmitData(USCI_B0_BASE, (uint8_t)(temp & 0x00FF ));
    // wait until done
    while (!USCI_B_SPI_getInterruptStatus(USCI_B0_BASE,
                                            USCI_B_SPI_RECEIVE_INTERRUPT));
    dummy1 = USCI_B_SPI_receiveData(USCI_B0_BASE);
    ...
    while (!USCI_B_SPI_getInterruptStatus(USCI_B0_BASE,
                                            USCI_B_SPI_RECEIVE_INTERRUPT)) ;
    dummy2 =  USCI_B_SPI_receiveData(USCI_B0_BASE);

    //USCI_B0 TX buffer ready?
    while (!USCI_B_SPI_getInterruptStatus(USCI_B0_BASE,
                                        USCI_B_SPI_TRANSMIT_INTERRUPT));
    //Transmit LSB to slave
    USCI_B_SPI_transmitData(USCI_B0_BASE, (uint8_t)(temp & 0xFF ));
    // wait until done
    while (!USCI_B_SPI_getInterruptStatus(USCI_B0_BASE,
                                            USCI_B_SPI_RECEIVE_INTERRUPT));
    dummy3 = USCI_B_SPI_receiveData(USCI_B0_BASE);
